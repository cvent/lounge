...
class CouchbaseDocument extends Document {
  ...
  _populatePath (options, memo, missing, fn) {
    ...
    if (!fullPath) {
      ...
      // get model
      Model = cdocUtils.getRefModel.call(this, part)
      if (!Model) {
      ...
      Model = cdocUtils.getRefModel.call(this, path)
    }
  ...
  _populate (options, memo, fn) {
    ...
    if (options.populate === true) {
      ...
      cdocUtils.populateAll.call(this, refs, options, memo, missing, fn)

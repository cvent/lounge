 ...
 * @param {Boolean} raw if true returns the raw CAS document. If false, returns string representation of CAS. Default false.
 * @returns {*}
 */
 ...
 * @param {Object} data optional sets the objects params to data
 * @param {Object} options save options. All options not present here are first looked up from schema options, and then
 *                from config options.
 *          - storeFullReferenceId - whether to save embedded document property values as full document keys or just
 *                                 the base value
 ...
 * @param {Object} options options to be passed to the couchbase remove function.
 * @param fn
 */

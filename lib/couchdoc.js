 ...
 * @interface
 * @param raw to return the actual CAS object. Otherwise we return string representation. Default:false
 */
 ...
 * @param options save options. All options not present here are first looked up from schema options, and then
 *                from config options.

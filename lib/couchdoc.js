 ...
 * @param fn
 */
CouchbaseDocument.prototype.$_saveRef = function (path, changedRefs, options, fn) {
  var self = this;
 ...
 * @param fn
 */
CouchbaseDocument.prototype.$_populateAll = function (refs, options, memo, missing, fn) {
  var self = this;
  async.eachLimit(refs, 10, function (path, eachCB) {
...
CouchbaseDocument.prototype.$_populatePath = function (options, memo, missing, fn) {
  var self = this;

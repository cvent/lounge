...
var schemaConfigOptions = ['keyPrefix', 'keySuffix', 'refIndexKeyPrefix', 'delimiter'];
 ...
 * @api public
 * @param options
 *        keyPrefix             - key prefix for all keys. No default. Generally useful if you wish to namespace
 *                                documents. Example: `app::env::`.
 ...
 *        waitForIndex          - When documents are saved, indexes are updated. We can wait for this operation to
 *                                finish before returning from `save()`. Default: false
 */
...
/**
 * Creates a schema. Prefer to use this over Schema conststructor as this will pass along Lounge config settings.
 *
 * @api public

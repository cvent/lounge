...
export default class Lounge extends EventEmitter {
   ...
   *                                       See {@link https://github.com/bojand/couchbase-driver}
   * @param {Boolean} options.promisify - to enable promise support. By default all async functions except
   *                                      <code>Lounge.connect()</code> support promises and return a promise.
   *                                      <code>Lounge.connect()</code> returns an instance of <code>Bucket</code> to keep
   *                                      consistancy with couchbase library. To disable promise support set this
   *                                      option to <code>false</code>, ideally at start before doing <code>connect</code> or any other
   *                                      operations. Default: <code>true</code>.
   *
   * @returns {Lounge}
   */
  constructor(options = {}) {

...
export default class Lounge extends EventEmitter {
   ...
   * @param {Number} options.atomicRetryTimes - The number of attempts to make within <code>Driver.atomic()</code>.
   ...
   * @param {Boolean} options.atomicLock - Whether to use get and lock during atomic operations within indexing. Default: <code>true</code>.
   *
   * @returns {Lounge}
   */
  constructor(options = {}) {

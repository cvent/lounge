...
export const saveOptionsKeys = ['storeFullReferenceId', 'storeFullKey', 'refIndexKeyPrefix', 'waitForIndex', 'toObject.minimize']
...
export function expandValues (valueList) {
  let retVal = []
...
export function processValue (initialValue) {
  let finalVal = null
